  ...
  return (
    <div className="home">
      ...
      <div className="watch">
        ...
        <p className="introduce">There is no magic formula to write perfect ad copy. It is based on a number of factors, including ad placement,<br /> demographic, even the consumer’s mood.</p>
        <div className="movie">
      ...
      <div className="content-five">
        ...
        <p style={{fontSize:'40px'}}>Simple & Colorful Ecommerce <br /> Template for Your Business</p>
        <div className="content-main">
          <div className="main-left">
            <p style={{fontSize:'25px'}}>Available for FREE!</p>
            <p style={{border:'2px solid #a5c926', width:'80px'}}></p>
            <p style={{color:'#999999'}}>A successful marketing plan relies heavily on the pulling-power of advertising copy. Writing result-oriented ad copy is difficult, as it must appeal to, entice, and convince consumers to take action. There is no magic formula to write perfect ad copy</p>
            <button>GET IT NOW!</button>
          </div>
          <img src="https://assets.website-files.com/5badda2935e11303a89a461e/5bb5c77ee73150e2021b0db4_side-image-01-p-1080.jpeg" alt="" width='40%' />
        </div>
      </div>
